package com.neubofy.remotemanager.Services;
...
import com.neubofy.remotemanager.RcloneRcd;
import com.neubofy.remotemanager.util.FLog;
import com.neubofy.remotemanager.util.FlagsUtil;
import com.neubofy.remotemanager.util.NotificationUtils;
...
public class RcdService extends Service implements RcloneRcd.JobsUpdateHandler {
    ...
    public static final String ACTION_START_FOREGROUND = "com.neubofy.remotemanager.RcdService.StartForeground";
    public static final String ACTION_STOP_FOREGROUND = "com.neubofy.remotemanager.RcdService.StopForeground";
     ...
     * @{@link com.neubofy.remotemanager.VirtualContentProvider}) may use the service for longer time
    ...
    public static class RcdServiceAction extends BroadcastReceiver {
        ...
        public static final String ACTION_STOP_ALL = "com.neubofy.remotemanager.RcdService.Stop";
        public static final String ACTION_PAUSE = "com.neubofy.remotemanager.RcdService.Pause";
