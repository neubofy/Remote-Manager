...
import com.neubofy.remotemanager.BroadcastReceivers.TriggerReciever;
...
import com.neubofy.remotemanager.notifications.AppErrorNotificationManager;
    ...
    private void queueSingleIntervalTrigger(Trigger trigger){
        if(trigger.isEnabled()){
            ...
            androidx.work.PeriodicWorkRequest periodicWork = new androidx.work.PeriodicWorkRequest.Builder(
                com.neubofy.remotemanager.workmanager.SyncWorker.class,
                intervalMinutes,
                java.util.concurrent.TimeUnit.MINUTES
            )
            .setInputData(new androidx.work.Data.Builder().putLong(com.neubofy.remotemanager.workmanager.SyncWorker.TASK_ID, trigger.getTriggerTarget()).build())
