...
import com.neubofy.remotemanager.BroadcastReceivers.ServeCancelAction;
...
public class StreamingService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        Intent foregroundIntent = new Intent(this, com.neubofy.remotemanager.Activities.MainActivity.class);
