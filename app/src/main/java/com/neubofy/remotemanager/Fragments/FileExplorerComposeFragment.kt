...
import com.neubofy.remotemanager.Dialogs.*
import com.neubofy.remotemanager.FilePicker
import com.neubofy.remotemanager.data.CacheManager
...
import com.neubofy.remotemanager.ui.FileExplorerComposeScreen
import com.neubofy.remotemanager.ui.viewmodel.FileExplorerViewModel
import com.neubofy.remotemanager.util.ActivityHelper.tryStartService
import com.neubofy.remotemanager.util.FLog
import com.neubofy.remotemanager.workmanager.EphemeralTaskManager
        ...
        if (currentRemote.isRemoteType(RemoteItem.LOCAL, RemoteItem.SAFW) || currentRemote.isPathAlias) {
            try {
                ...
                if (localFile.exists()) {
                    ...
                    com.neubofy.remotemanager.util.DefaultOpenerHelper.launchWithConfiguredOpener(
