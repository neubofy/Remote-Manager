...
import com.neubofy.remotemanager.util.Rfc3339Deserializer;
...
public class RcloneRcd {
    ...
    /**
     * Less memory overhead than {@link com.neubofy.remotemanager.Items.FileItem} by removing pregenerated formatting
     */
    @JsonIgnoreProperties(ignoreUnknown = true)
