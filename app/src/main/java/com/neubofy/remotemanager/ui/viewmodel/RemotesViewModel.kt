package com.neubofy.remotemanager.ui.viewmodel
...
class RemotesViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        val cachedQuotas = com.neubofy.remotemanager.data.RemoteTelemetryCacheRepository.getAll(application)
    ...
    fun loadRemotes(force: Boolean = false) {
        viewModelScope.launch {
            ...
            val cachedQuotas = com.neubofy.remotemanager.data.RemoteTelemetryCacheRepository.getAll(getApplication())
            _uiState.update {
                it.copy(
    ...
    fun fetchStorageQuota(remote: RemoteItem) {
        ...
        val cached = com.neubofy.remotemanager.data.RemoteTelemetryCacheRepository.get(getApplication(), remote.name)
        ...
        viewModelScope.launch {
            ...
            if (result != null && !result.hasFailed()) {
                com.neubofy.remotemanager.data.RemoteTelemetryCacheRepository.put(getApplication(), remote.name, result)
            }
        ...
        viewModelScope.launch {
            ...
            withContext(Dispatchers.IO) {
                try {
                    ...
                    com.neubofy.remotemanager.data.RemoteTelemetryCacheRepository.remove(getApplication(), remote.name)
                    com.neubofy.remotemanager.data.DirectoryCacheRepository.invalidateRemote(remote.name)
                } catch (e: Exception) {
