package com.neubofy.remotemanager.Dialogs;
...
import com.neubofy.remotemanager.InteractiveRunner;
import com.neubofy.remotemanager.InteractiveRunner.ErrorHandler;
import com.neubofy.remotemanager.InteractiveRunner.Step;
import com.neubofy.remotemanager.InteractiveRunner.StringAction;
...
import com.neubofy.remotemanager.RemoteConfig.OauthHelper;
import com.neubofy.remotemanager.RemoteConfig.OauthHelper.InitOauthStep;
import com.neubofy.remotemanager.RemoteConfig.OauthHelper.OauthFinishStep;
...
public class RemotePropertiesDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        com.neubofy.remotemanager.Rclone.AboutResult cachedResult = com.neubofy.remotemanager.data.RemoteTelemetryCacheRepository.INSTANCE.get(context, remote.getName());
    ...
    private void updateStorageUsage() {
        ...
        new AboutRemoteTask(rclone, remote, result -> {
            ...
            if (context != null) {
                com.neubofy.remotemanager.data.RemoteTelemetryCacheRepository.INSTANCE.put(context, remote.getName(), result);
            }
            showStorageMetrics();
        }).execute();
    }
